...
class SingleArticlePrograma extends StatefulWidget {
  final dynamic article;
  final String heroId;

  SingleArticlePrograma(this.article, this.heroId, {Key key}) : super(key: key);

  @override
  _SingleArticleProgramaState createState() => _SingleArticleProgramaState();
}

class _SingleArticleProgramaState extends State<SingleArticlePrograma> {
